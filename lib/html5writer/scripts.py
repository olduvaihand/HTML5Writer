def rst2html5():
    ...
    publish_cmdline(writer_name='html5writer', description=description)
...
================  ============================================================
'''
    print publish_string(doc, writer_name="html5writer")
    #print publish_string(doc, writer_name="html")
